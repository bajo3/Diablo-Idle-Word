...
export const GAME_DATA: GameDataCatalog = {
  ...
  barbarianCombat: {
    combatFormulaVersion: 'barbarian-combat.1',
    tuningStatus: 'PROVISIONAL',
    level: 1,
    attributes: { strength: 14, dexterity: 6, intelligence: 3, vitality: 14 },
    weaponDamage: [12, 18],
    maxFury: 120,
    criticalBaseChance: 0.04,
    criticalPerDexterity: 0.004,
    criticalCap: 0.45,
    criticalMultiplier: 1.5,
    armorDenominatorBase: 100,
    armorDenominatorPerLevel: 50,
    armorReductionCap: 0.75,
    furyOnDamageTaken: 7,
    furyDecayDelayMs: 3500,
    furyDecayPerSecond: 4,
    battleThirst: { healFraction: 0.04, capFraction: 0.12, windowMs: 10_000 },
    abilities: [
      {
        id: 'ability.barbarian.cleave',
        input: 'primary',
        furyCost: 0,
        cooldownMs: 550,
      ...
      {
        id: 'ability.barbarian.berserker_oath',
        input: 'q',
        furyCost: 70,
        cooldownMs: 14_000,
      ...
      {
        id: 'ability.barbarian.blood_rush',
        input: 'passive',
        furyCost: 0,
        cooldownMs: 0,
        damageMultiplier: 0,
      ...
      {
        id: 'ability.barbarian.rallying_hide',
        input: 'e',
        furyCost: 35,
        cooldownMs: 12_000,
        damageMultiplier: 0,
  ...
  enemies: [
    ...
    // The Skeleton line (Paso 10): five level-scaled reskins of the same undead-warrior archetype,
    // one tier roughly every two character levels across the 1-10 cap — mirroring how Diablo II
    // reuses a monster family (Skeleton -> Returned -> Bone Warrior) at increasing area levels
    // instead of inventing a new enemy per level. `skeletonTierForLevel` in enemy-visuals.ts picks
    // the active tier; `zone.enemyIds` below lists all five so the zone can spawn any of them.
    {
      id: 'skeleton_recruit',
  ...
  enemyTuning: [
    ...
    // Skeleton line, weakest to strongest — see the matching `enemies` entries above for why five
    // separate ids exist instead of one enemy with a level field.
    {
      enemyId: 'skeleton_recruit',
      tuningStatus: 'PROVISIONAL',
      maxHealth: 34,
      armor: 4,
      moveSpeedPxPerSec: 84,
      separationRadiusPx: 28,
      detectRadiusPx: 210,
      loseTargetRadiusPx: 310,
      leashRadiusPx: 410,
      attack: {
        weaponDamage: [5, 7],
        power: 2,
      ...
      materialsReward: 1,
      animationIds: [
        'enemy.skeleton_recruit.idle.down',
        'enemy.skeleton_recruit.moving.down',
        'enemy.skeleton_recruit.attacking.down',
      ],
      frameSize: 92,
    },
    {
      ...
      materialsReward: 1,
      animationIds: [
        'enemy.skeleton_warrior.idle.down',
        'enemy.skeleton_warrior.moving.down',
        'enemy.skeleton_warrior.attacking.down',
      ],
      frameSize: 92,
    },
    {
      enemyId: 'bone_soldier',
      tuningStatus: 'PROVISIONAL',
      maxHealth: 80,
      armor: 11,
      moveSpeedPxPerSec: 82,
      separationRadiusPx: 30,
      detectRadiusPx: 230,
      loseTargetRadiusPx: 330,
      leashRadiusPx: 430,
      attack: {
        weaponDamage: [10, 14],
        power: 4,
      ...
      materialsReward: 2,
      animationIds: [
        'enemy.bone_soldier.idle.down',
        'enemy.bone_soldier.moving.down',
        'enemy.bone_soldier.attacking.down',
      ],
      frameSize: 92,
    },
    {
      enemyId: 'bone_warlord',
      tuningStatus: 'PROVISIONAL',
      maxHealth: 115,
      armor: 16,
      moveSpeedPxPerSec: 78,
      separationRadiusPx: 32,
      detectRadiusPx: 260,
      loseTargetRadiusPx: 380,
      leashRadiusPx: 480,
      attack: {
      ...
      materialsReward: 2,
      animationIds: [
        'enemy.bone_warlord.idle.down',
        'enemy.bone_warlord.moving.down',
        'enemy.bone_warlord.use_ability.down',
      ],
      frameSize: 92,
    },
    {
      ...
      materialsReward: 3,
      animationIds: [
        'enemy.skeleton_king.idle.down',
        'enemy.skeleton_king.moving.down',
        'enemy.skeleton_king.use_ability.down',
      ],
      frameSize: 92,
    },
  ],
  ...
  contentExpansion: {
    registryVersion: 'content-expansion.1',
    enemies: [
      {
        id: 'spore_stalker',
        displayName: 'Acechador de esporas',
        archetype: 'melee',
        behaviors: ['melee', 'reposition'],
        aiStates: [
          'idle',
          'patrol',
          'detect',
      ...
      {
        id: 'ash_crawler',
        displayName: 'Rastreador de ceniza',
        archetype: 'melee',
        behaviors: ['melee', 'fast_pursuit'],
        aiStates: [
          'idle',
          'patrol',
          'detect',
      ...
      {
        id: 'veil_wraith',
        displayName: 'Espectro del velo',
        archetype: 'ranged',
        behaviors: ['ranged', 'keep_distance', 'stun'],
        aiStates: [
          'idle',
          'patrol',
          'detect',
      ...
      {
        id: 'stonebound_sentinel',
        displayName: 'Centinela petreo',
        archetype: 'melee',
        behaviors: ['melee', 'area_attack', 'stun'],
        aiStates: [
          'idle',
      ...
      {
        id: 'rift_howler',
        displayName: 'Aullador de la brecha',
        archetype: 'caster',
        behaviors: ['telegraphed_explosion', 'reposition'],
        aiStates: [
          'idle',
          'patrol',
          'detect',
    ...
    maps: [
      {
        id: 'map.spore_marsh',
        zoneId: 'spore_marsh',
        backgroundAssetId: 'background.spore_marsh',
        format: 'tiled',
        version: GAME_DATA_VERSION,
        tuningStatus: 'TBD',
      },
      {
        id: 'map.ash_mines',
        zoneId: 'ash_mines',
        backgroundAssetId: 'background.ash_mines',
        format: 'tiled',
        version: GAME_DATA_VERSION,
        tuningStatus: 'TBD',
      },
      {
        id: 'map.threshold_ruins',
        zoneId: 'threshold_ruins',
        backgroundAssetId: 'background.threshold_ruins',
        format: 'tiled',
        version: GAME_DATA_VERSION,
        tuningStatus: 'TBD',
      },
    ...
    zones: [
      {
        id: 'spore_marsh',
        displayName: 'Pantano de Esporas',
        mapId: 'map.spore_marsh',
        enemyIds: ['spore_stalker', 'veil_wraith'],
        awayModeEligible: true,
        tuningStatus: 'TBD',
      },
      {
        id: 'ash_mines',
        displayName: 'Minas de Ceniza',
        mapId: 'map.ash_mines',
        enemyIds: ['ash_crawler', 'stonebound_sentinel'],
        awayModeEligible: true,
        tuningStatus: 'TBD',
      },
      {
        id: 'threshold_ruins',
        displayName: 'Ruinas del Umbral',
        mapId: 'map.threshold_ruins',
        enemyIds: ['rift_howler', 'stonebound_sentinel', 'veil_wraith'],
        awayModeEligible: false,
        tuningStatus: 'TBD',
      },
    ],
  },
  // M1 scaffold of the content expansion (docs/plans/all-content-expansion.md): all seven playable
  // class IDs are catalogued with provisional shared resource data, while branches and nodes remain
  // empty until each class vertical slice is designed and tested.
  classRegistry: {
    ...
    classes: [
      ...
      },
      {
        ...
        schemaVersion: 'class-registry.1',
        displayName: 'Amazona',
        roleTags: ['ranged', 'mobility'],
        resource: 'provisional_guardian_fury',
        attributeIds: ['strength', 'dexterity', 'intelligence', 'vitality'],
        branchIds: [],
      },
      {
    ...
    nodes: [
      {
        ...
        description: 'Golpe frontal que genera Rabia y alcanza a varios enemigos cercanos.',
        requirements: { unlockLevel: 1, pointCost: 1 },
        tags: ['melee', 'area', 'rage_generator'],
        abilityId: 'ability.barbarian.cleave',
        effectIds: ['effect.barbarian.cleave'],
        schemaVersion: 'class-registry.1',
      },
      {
        ...
        description: 'Los golpes consecutivos aumentan brevemente la velocidad de movimiento.',
        requirements: {
          unlockLevel: 2,
          prerequisiteNodeId: 'node.barbarian.bloodsong.cleave',
          pointCost: 1,
        },
        tags: ['melee', 'mobility', 'combo'],
        effectIds: ['effect.barbarian.blood_rush'],
        schemaVersion: 'class-registry.1',
      },
      {
        ...
        branchId: 'branch.barbarian.bloodsong',
        kind: 'ultimate',
        displayName: 'Juramento del coloso',
        description: 'Consume Rabia para entrar en frenesí: más daño, pero sin invulnerabilidad.',
        requirements: {
          unlockLevel: 6,
          prerequisiteNodeId: 'node.barbarian.bloodsong.blood_rush',
          pointCost: 3,
        },
        tags: ['melee', 'ultimate', 'berserk'],
        abilityId: 'ability.barbarian.berserker_oath',
        effectIds: ['effect.barbarian.berserker_oath'],
        schemaVersion: 'class-registry.1',
      },
    ],
    effects: [
      {
        effectId: 'effect.barbarian.cleave',
        kind: 'damage',
        targeting: 'area',
        tags: ['physical', 'rage_generation'],
        tuningStatus: 'PROVISIONAL',
        schemaVersion: 'combat-effect.1',
      },
      {
        effectId: 'effect.barbarian.blood_rush',
        kind: 'buff',
        targeting: 'self',
        tags: ['movement_speed', 'stacks'],
        tuningStatus: 'PROVISIONAL',
        schemaVersion: 'combat-effect.1',
      },
      {
        effectId: 'effect.barbarian.berserker_oath',
        kind: 'buff',
        targeting: 'self',
        tags: ['damage', 'rage_cost', 'telegraph'],
        tuningStatus: 'PROVISIONAL',
        schemaVersion: 'combat-effect.1',
      },
    ],
